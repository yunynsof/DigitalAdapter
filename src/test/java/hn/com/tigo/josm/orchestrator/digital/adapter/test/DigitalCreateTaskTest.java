...
public class DigitalCreateTaskTest extends AbstractTest{

	public DigitalCreateTaskTest() throws Exception {
		super("java:global/DigitalAdapter/DigitalServiceCreateTask!hn.com.tigo.josm.common.adapter.task.Task");
	}
