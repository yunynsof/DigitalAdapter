...
public class DigitalDeleteTaskTest extends AbstractTest{

	public DigitalDeleteTaskTest() throws Exception {
		super("java:global/DigitalAdapter/DigitalServiceDeleteTask!hn.com.tigo.josm.common.adapter.task.Task");
	}
